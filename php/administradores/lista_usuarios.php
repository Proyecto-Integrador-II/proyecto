	...
	<body>     
        ...
        <section id="container">
            ...
            <?php
				...
				$sql_registe = sqlsrv_query($conection,"SELECT COUNT(*) AS total_registro FROM usuario WHERE habilitado =1");
                ...
                $query = sqlsrv_query($conection, "SELECT u.idusuario, u.nombre,u.apellido,u.correo,r.rol FROM usuario u INNER JOIN rol r ON u.rol = r.idrol where habilitado =1 ORDER BY u.idusuario OFFSET $desde ROWS FETCH NEXT $por_pagina ROWS ONLY");
